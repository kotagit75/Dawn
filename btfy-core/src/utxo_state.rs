...
mod tests {
    ...
    use crate::coinbase::coinbase_transaction;
    ...
    fn dummy_block(prev: &Block, txs: Vec<crate::transaction::Transaction>, beacon: i32) -> Block {
        Block {
            index: prev.index + 1,
    ...
    fn chain_with_coinbase(miner: &Address) -> crate::chain::Chain {
        let g = genesis_block();
